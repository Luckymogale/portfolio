...
var business = ["Sunny", "Partly Sunny", "Partly Cloudy", "Cloudy", "Raining", "Snowing", "Thunderstorm", "Foggy"];
...
/**
generates business for the week
**/
function generatebusiness() {
    var weatherToday;
    var tempToday;
    for (var i = 0; i < days.length; i++) {
        businessToday = business[Math.floor(Math.random() * business.length)];
...
/**
calculates glasses of business sold
**/
...
function displayResults(weeklyInventory, glassPrice, weeklySales) {
    ...
    var expense = weeklyInventory * businessCost;
    ...
    document.getElementById("result").innerHTML += "<p>Each glass costs you $" + businessCost + ". Your profit was $" + profit + ".";
}
