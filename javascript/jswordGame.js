...
function replaceIt() {
    ...
    var noun = "<span class='replacement'>" + document.getElementById("noun").value + "</span>";
    ...
    var adjective = "<span class='replacement'>" + document.getElementById("adjective").value + "</span>";
    ...
    theStory += "Douglas danced  " + adverb + ".<br><br>";
